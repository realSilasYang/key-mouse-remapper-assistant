...
RunScriptRuleRuntimeTests() {
    ...
    try {
        ...
        descendantCode := "#Requires AutoHotkey v2.0`n"
            ...
            . "if !isChild {`n"
            . "    Run(QuoteForChild(A_AhkPath) ' /ErrorStdOut ' "
            ...
            . "), , 'Hide', &externalPid)`n"
            . "    AppendMarker('E:' externalPid '|', "
            . Chr(34) escapedDescendantMarker Chr(34) ")`n}`n"
            . "AppendMarker((isChild ? 'C:' : 'P:') "
            . "DllCall('kernel32\GetCurrentProcessId', 'UInt') '|', "
            . Chr(34) escapedDescendantMarker Chr(34) ")`n"
            . "Persistent`n"
            . "AppendMarker(value, path) {`n"
            . "    Loop 100 {`n"
            . "        try {`n"
            . "            FileAppend(value, path)`n"
            . "            return`n"
            . "        } catch as writeError {`n"
            . "            if A_Index >= 100`n"
            . "                throw writeError`n"
            . "            Sleep(10)`n"
            . "        }`n"
