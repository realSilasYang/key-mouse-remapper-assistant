...
class UiThemeService {
    ...
    static GetActualTheme() => this.ActualTheme
    ...
    static GetPalette() {
        ...
        return {
            ...
            Primary: palette["Primary"], Add: palette["Add"],
    ...
    static DarkPalette() {
        static palette := Map(
            ...
            "Primary", "0078D7", "Add", "3F6B5B", "Delete", "6B4B4B",
    ...
    static LightPalette() {
        static palette := Map(
            ...
            "Text", "1E293B", "MutedText", "526170", "HintText", "64748B",
            "Link", "0969DA", "ReadonlyText", "334155",
            "Primary", "0F6CBD", "Add", "4B7F6B", "Delete", "A95F5F",
            "DeleteDisabled", "787676", "Pause", "8C7138",
            "PauseDisabled", "777671", "Tooltip", "F8FAFC",
            "TooltipText", "1E293B", "Error", "B42318",
            "DisabledText", "667085", "ButtonText", "FFFFFF",
            "ToolbarText", "334155", "DisabledButtonText", "FFFFFF",
            "CodeGutter", "E8EDF2", "CodeLineNumber", "6B7280",
    ...
    static GetItemsViewThemeName() {
        return this.IsDark() ? "DarkMode_ItemsView" : "ItemsView"
    }

    static GetListThemeName() {
        return this.GetExplorerThemeName()
    }
}
